...
@section('content')
            <section class="content-body">
					...
					<div class="row">
						<div class="col-md-12">
							<form action="{{url('mustahiq/simpan')}}" method="POST" class="form-horizontal">
							@csrf
								<section class="panel">
									<header class="panel-heading">
										<a href="{{route('mustahiq.index')}}" class="btn btn-success"><i class="fa fa-eye"></i> Lihat Data</a>	
									</header>
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama Mustahiq <span class="required">*</span></label>
											<div class="col-sm-6">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Deskripsi <span class="required">*</span></label>
											<div class="col-sm-9">
